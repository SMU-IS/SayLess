<template>
  <div
    class="flex flex-col md:flex-row text-white justify-between items-center h-screen gap-4 lg:mb-44 mx-6 md:mx-12"
  >
    <DetailsHeader @header-click="goBack">{{ details.title }}</DetailsHeader>

    <div class="flex flex-col gap-5 md:flex-row md:mt-24">
      <!-- Left side (Image) -->
